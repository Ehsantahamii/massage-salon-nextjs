...
export const metadata = {
  title: "توکسن تراپی ماساژ: راهکاری نوین برای سم‌زدایی بدن و بهبود سلامت",
  description:
    "توکسن تراپی ماساژ یکی از روش‌های نوین برای سم‌زدایی بدن و بهبود عملکرد سیستم لنفاوی است. این روش ترکیبی از تکنیک‌های ماساژ درمانی و متدهای سم‌زدایی است که می‌تواند به کاهش استرس، بهبود جریان خون و ارتقای سلامت عمومی بدن کمک کند.",
  keywords: [
    ...
    "ماساژ سم‌زدا",
    "سم‌زدایی بدن با ماساژ",
    "ماساژ برای پاکسازی بدن",
