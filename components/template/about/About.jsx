...
const About = () => {
  const skills = [
    { id: 1, text: "  ماساژ بالاتنه یا پایین تنه" },
    { id: 2, text: "ماساژ تخصصی صورت " },
    { id: 3, text: " ماساژ نقاط حیاتی " },
    { id: 4, text: " ماساژ لمس طبیعت (تاییوگا) " },
    { id: 5, text: " ماساژ سلطنتی" },
    { id: 6, text: "ماساژ بهبودیابی" },
    { id: 7, text: "ماساژ اسپورت" },
    { id: 8, text: "ماساژ سنگ های شفابخش" },
    { id: 9, text: "گرمای طلایی" },
    { id: 10, text: "ماساژ پر قو" },
    { id: 11, text: "جادوی رایحه ها" },
    { id: 12, text: "آرامش گرم" },
  ];
  return (
    <section className="w-full pb-14"  data-aos="fade-up"  data-aos-anchor-placement="top-bottom">
      <div className="about flex flex-col lg:flex-row-reverse lg:justify-between justify-center items-center gap-8 ">
        ...
        <div className="content_about flex flex-col leading-10 w-[700px] max-md:w-full max-md:p-2 lg:w-[60%] ">
          ...
          <div className="skilss flex justify-around items-center flex-wrap pt-2 gap-1">
            {skills.map((index) => (
              <div  key={index.id} className="bg-gray-200 flex justify-around items-center flex-wrap mt-2 py-1 px-2 rounded-md"><p>{index.text}</p></div>
            ))}
          </div>
        </div>
      </div>
