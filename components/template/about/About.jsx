  ...
  return (
    <div className="w-full my-14 max-md:mt-[-150px]">
      <div className="about flex flex-col lg:flex-row lg:justify-between justify-center items-center gap-8 ">
        ...
        <div className="content_about flex flex-col leading-10 w-[700px] max-md:w-full max-md:p-2 lg:w-[60%] " data-aos="fade-up">
          <h3 className="text-[50px] text-center lg:text-right font-bold mb-10">درباره من</h3>
